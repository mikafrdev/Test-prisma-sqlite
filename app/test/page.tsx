         ...
         <main className={cn(styles.homeContainer, "mainContainer")}>
            ...
            <div className={styles.homeCards}>
               <Card className={styles.homeCard}>
                  ...
                  <CardFooter className="justify-center">
                     <Button variant="outline">
                        <Link href="/backoffice/article/all">Backoffice ALL</Link>
                     </Button>
                  </CardFooter>
               </Card>
               <Card className={styles.homeCard}>
                  ...
                  <CardFooter className="justify-center">
                     <Button variant="outline">
                        <Link href="/backoffice/article/display">
                           Backoffice DISPLAY
                        </Link>
                     </Button>
                  </CardFooter>
               ...
               <Card className={styles.homeCard}>
                  ...
                  <CardFooter className="justify-center">
                     <Button variant="outline">
                        <Link href="/backoffice/article/add">Backoffice ADD</Link>
                     </Button>
                  </CardFooter>
               </Card>
               ...
               <Card className={styles.homeCard}>
                  ...
                  <CardFooter className="justify-center">
                     <Button variant="outline">
                        <Link href="/backoffice/article/update">Backoffice UPDATE</Link>
                     </Button>
                  </CardFooter>
               </Card>
